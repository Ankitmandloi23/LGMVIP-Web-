...
return(
<div>
{mode==='view' &&<button type='buitton' onClick={takeAction} target_action='add'>PRODUCT DETAILS</button>}
{mode==='add' &&<button type='buitton' onClick={takeAction} target_action='cancel'>CANCEL</button>}
</div>
)
}
